...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-v1_Token"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-entity_User"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-v1_TaskList"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-entity_Task"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-entity_Translation"
                                },
                                {
                                    "type": "object",
                                    "properties": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/v1.Ok-entity_TranslationHistory"
                                },
                                {
                                    "type": "object",
                                    "properties": {
    ...
    "definitions": {
        ...
        "v1.Ok-entity_TranslationHistory": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
